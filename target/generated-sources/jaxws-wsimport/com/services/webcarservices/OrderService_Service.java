 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://webcarservices.services.com/", wsdlLocation = "http://LAPTOP-GT898CL0:8080/CarServicesWebApp/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://webcarservices.services.com/", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://LAPTOP-GT898CL0:8080/CarServicesWebApp/OrderService?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://webcarservices.services.com/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webcarservices.services.com/", "OrderServicePort"), OrderService.class, features);
    }
