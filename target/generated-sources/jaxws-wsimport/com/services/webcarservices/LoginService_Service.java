 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://webcarservices.services.com/", wsdlLocation = "http://LAPTOP-GT898CL0:8080/CarServicesWebApp/LoginService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://webcarservices.services.com/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://LAPTOP-GT898CL0:8080/CarServicesWebApp/LoginService?wsdl");
    ...
    public LoginService getLoginServicePort() {
        return super.getPort(new QName("http://webcarservices.services.com/", "LoginServicePort"), LoginService.class);
    }
    ...
    public LoginService getLoginServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webcarservices.services.com/", "LoginServicePort"), LoginService.class, features);
    }
