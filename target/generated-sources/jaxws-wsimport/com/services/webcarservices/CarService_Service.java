 ...
 * 
 */
@WebServiceClient(name = "CarService", targetNamespace = "http://webcarservices.services.com/", wsdlLocation = "http://LAPTOP-GT898CL0:8080/CarServicesWebApp/CarService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CARSERVICE_QNAME = new QName("http://webcarservices.services.com/", "CarService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://LAPTOP-GT898CL0:8080/CarServicesWebApp/CarService?wsdl");
    ...
    public CarService getCarServicePort() {
        return super.getPort(new QName("http://webcarservices.services.com/", "CarServicePort"), CarService.class);
    }
    ...
    public CarService getCarServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webcarservices.services.com/", "CarServicePort"), CarService.class, features);
    }
