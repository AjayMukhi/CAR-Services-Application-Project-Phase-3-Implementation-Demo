<%-- 
    Document   : Adminpowertools
    Created on : Mar 27, 2018, 3:46:52 PM
    Author     : AjayMukhi
--%>
...
<html>
 ...
 <script>
       ...
       <%
        ...
        String role=(String)hs.getAttribute("role");
         ...
         hs.setAttribute("userid", uname);
                            ...
                            List<CarParts> carpartsList = car.getCarPartsPowerTorqueList();
                              ...
                              color:red; font-size:18px;text-align:center">Our Price:</span>
                               ...
                               <c:out value="${carparts.price}"></c:out></span>
                                    ...
                                    <form class = 'submit-button' method = 'post' action = 'addtoCart'>
                                      ...
                                      <input class = 'submit-button' type = 'submit' name = 'PowerTorque' value = ' Add to Cart'>
                                    ...
                                    <% if(!role.equalsIgnoreCase("customer")){ %>
                                      ...
                                      <input class = 'submit-button'  type = 'submit'  name = 'UpdatePowerTorque' value = 'Update'>
                                      ...
                                      <input class = 'submit-button'  type = 'submit' name = 'DeletePowerTporque' value = 'Delete'>
                                      <input type='hidden' name='model' value='<c:out value="${carparts.id}"></c:out>'>                      
                                     </form>
                                 <% } %>
                                     <br>
	...
	<h4>Shop by Parts</h4>
	<ul>
            <li><a href='./Adminpowertools.jsp'>Power Torque Hand Tools</a></li>
            <li><a href='./Adminarmour.jsp'>Armour All</a></li>
	    <li><a href='./Adminacdelco.jsp'>AC Delco</a></li>
            <li><a href='./Adminrotella.jsp'>Shell Rotella</a></li>
            <li><a href='./Admintowels.jsp'>Tub O'Towels</a></li>	
	</ul>
	</li>	
	<li>
	<h4>About us</h4>
