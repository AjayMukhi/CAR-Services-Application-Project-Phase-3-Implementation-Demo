<%-- 
    Document   : AdminDoorWS
    Created on : Mar 27, 2018, 4:28:15 PM
    Author     : AjayMukhi
--%>
       ...
       <%
        ...
        String role=(String)hs.getAttribute("role");
         ...
         hs.setAttribute("userid", uname);
                            ...
                            List<CarParts> carpartsList = car.getCarPartsDoorWeatherstripSteelList();
                              ...
                              color:red; font-size:18px;text-align:center">Our Price:</span>
                               ...
                               <c:out value="${carparts.price}"></c:out></span>
                                    ...
                                    <form class = 'submit-button' method = 'post' action = 'addtoCart'>
                                      ...
                                      <input class = 'submit-button' type = 'submit' name = 'DoorWS' value = ' Add to Cart'>
                                    ...
                                    <% if(!role.equalsIgnoreCase("customer")){ %>
                                      ...
                                      <input class = 'submit-button'  type = 'submit'  name = 'UpdateDoorWS' value = 'Update'>
                                      ...
                                      <input class = 'submit-button'  type = 'submit' name = 'DeleteDoorWS' value = 'Delete'>
                                      <input type='hidden' name='model' value='<c:out value="${carparts.id}"></c:out>'>                      
                                     </form>
                                 <% } %>
                                     <br>
