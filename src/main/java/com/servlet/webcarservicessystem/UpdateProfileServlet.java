    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //carList.
             ...
             if(updateSuccess)
                 response.sendRedirect("ProfilePage.jsp?msg=Profile updated Successfully");
             else
                 response.sendRedirect("UpdateProfile.jsp?msg1=There is some problem in Updating the Profile into database.");
