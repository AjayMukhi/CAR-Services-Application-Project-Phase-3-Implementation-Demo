<%-- 
    Document   : Adminarmour
    Created on : Mar 27, 2018, 3:47:28 PM
    Author     : AjayMukhi
--%>
       ...
       <%
        ...
        String role=(String)hs.getAttribute("role");
         ...
         hs.setAttribute("userid", uname);
                            ...
                            List<CarParts> carpartsList = car.getCarPartsArmourAllList();
                              ...
                              color:red; font-size:18px;text-align:center">Our Price:</span>
                               ...
                               <c:out value="${carparts.price}"></c:out></span>
                                    ...
                                    <form class = 'submit-button' method = 'post' action = 'addtoCart'>
                                      ...
                                      <input class = 'submit-button' type = 'submit' name = 'ArmourAll' value = ' Add to Cart'>
                                    ...
                                    <% if(!role.equalsIgnoreCase("customer")){ %>
                                      ...
                                      <input class = 'submit-button'  type = 'submit'  name = 'UpdateArmourAll' value = 'Update'>
                                      ...
                                      <input class = 'submit-button'  type = 'submit' name = 'DeleteArmourAll' value = 'Delete'>
                                      <input type='hidden' name='model' value='<c:out value="${carparts.id}"></c:out>'>                      
                                     </form>
                                 <% } %>
                                     <br>
