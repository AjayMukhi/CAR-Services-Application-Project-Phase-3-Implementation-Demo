...
<%-- 
    Document   : chevrolet
    Created on : Mar 26, 2018, 9:59:57 PM
    Author     : AjayMukhi
--%>
 ...
 <script>
    ...
    width: 75%;">
            ...
            <%
                            ...
                            List<Car> carList = car.getCarChevroletList();
 ...
 %>
           ...
           <% }else{ %>
                        ...
                        <table>
                          <tr>
                              ...
                              color:red; font-size:20px;text-align:center">Our Price:</span>
                                   ...
                                   <span class="detail-label" style="font-weight: bold;
                                   font-size:20px;text-align:center">Description</span>
                                            <span class="detail-content"><c:out value="${car.description}"></c:out></span>
             ...
             <% if(!role.equalsIgnoreCase("customer")){ %>                
                    ...
                    <input type='hidden' id='productid' name='productid' value='<c:out value="${car.productId}"></c:out>'> 
                    </form>
