<%-- 
    Document   : AdminAntenna
    Created on : Mar 27, 2018, 4:25:34 PM
    Author     : AjayMukhi
--%>
                              ...
                              color:red; font-size:18px;text-align:center">Our Price:</span>
                               ...
                               <c:out value="${carparts.price}"></c:out></span>
                                    ...
                                    <form class = 'submit-button' method = 'post' action = 'addtoCart'>
                                      ...
                                      <input class = 'submit-button' type = 'submit' name = 'Antenna' value = ' Add to Cart'>
                                      ...
                                      <input type='hidden' name='userid' value='(String)hs.getAttribute("userid")'>
                                    </form>
                                   </td>
                                  ...
                                  <% if(!role.equalsIgnoreCase("customer")){ %>                     
                                      ...
                                      <input class = 'submit-button'  type = 'submit'  name = 'UpdateAntenna' value = 'Update'>
                                      ...
                                      <input class = 'submit-button'  type = 'submit' name = 'DeleteAntenna' value = 'Delete'>
                                      <input type='hidden' name='model' value='<c:out value="${carparts.id}"></c:out>'>                      
                                     </form>
                                     <% } %>
