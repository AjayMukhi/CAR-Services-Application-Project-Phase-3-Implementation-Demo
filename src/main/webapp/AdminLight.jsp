<%-- 
    Document   : AdminLight
    Created on : Mar 27, 2018, 4:32:35 PM
    Author     : AjayMukhi
--%>
                              ...
                              color:red; font-size:18px;text-align:center">Our Price:</span>
                               ...
                               <c:out value="${carparts.price}"></c:out></span>
                                    ...
                                    <form class = 'submit-button' method = 'post' action = 'addtoCart'>
                                      ...
                                      <input class = 'submit-button' type = 'submit' name = 'Light' value = ' Add to Cart'>
                                    ...
                                    <% if(!role.equalsIgnoreCase("customer")){ %>
                                      ...
                                      <input class = 'submit-button'  type = 'submit'  name = 'UpdateLight' value = 'Update'>
                                      ...
                                      <input class = 'submit-button'  type = 'submit' name = 'DeleteLight' value = 'Delete'>
                                      <input type='hidden' name='model' value='<c:out value="${carparts.id}"></c:out>'>                      
                                     </form>
                                 <% } %>
                                     <br>
